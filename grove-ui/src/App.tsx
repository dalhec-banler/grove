...
export default function App() {
  ...
  const { indicatorRef, labelRef, isRefreshing } = usePullToRefresh(mainScrollRef, refreshAll);
  ...
  return (
    <div className="flex h-full relative" {...upload.dragHandlers}>
      ...
      <main ref={mainScrollRef} className="flex-1 flex flex-col min-w-0 pb-14 md:pb-0">
        <div
          ref={indicatorRef}
          className="flex items-center justify-center text-muted text-xs overflow-hidden h-[72px] -mt-[72px] will-change-transform md:hidden"
